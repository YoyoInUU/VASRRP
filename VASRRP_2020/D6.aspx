<%@ Page Language="VB" AutoEventWireup="false" CodeFile="D6.aspx.vb" Inherits="D6" Debug="true" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <table border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        <td class="boxtd" id="bbox4">
                            <img src="VASRRP_files/sarrbox4.gif" alt="" class="dragitem" id="box4" style="position: absolute" />
                    ...
                    <tr>
                        <td class="boxtd" id="bbox5">
                            <img src="VASRRP_files/sarrbox5.gif" alt="" class="dragitem" id="box5" style="position: absolute" />
                            <img src="VASRRP_files/sarrqbox5.gif" alt="" id="qbox5" style="display: none; position: absolute" />
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="boxtd" id="bbox6">
                            <img src="VASRRP_files/sarrbox6.gif" alt="" class="dragitem" id="box6" style="position: absolute" />
                            <img src="VASRRP_files/sarrqbox6.gif" alt="" id="qbox6" style="display: none; position: absolute" />
                        </td>
                        <td>
        ...
        <img src="VASRRP_files/arrbox3.gif" width="1" alt="" id="Img3" />
        <img src="VASRRP_files/arrbox4.gif" width="1" alt="" id="Img4" />
        <img src="VASRRP_files/arrbox5.gif" width="1" alt="" id="Img5" />
        <img src="VASRRP_files/arrbox6.gif" width="1" alt="" id="Img6" />
        ...
        <div style="display: none">
            ...
            C:
            <asp:TextBox ID="xbox3" runat="server" Text="-1" Width="50"></asp:TextBox>
            D:
            <asp:TextBox ID="xbox4" runat="server" Text="-1" Width="50"></asp:TextBox>
            E:
            <asp:TextBox ID="xbox5" runat="server" Text="-1" Width="50"></asp:TextBox>
            F:
            <asp:TextBox ID="xbox6" runat="server" Text="-1" Width="50"></asp:TextBox>

        </div>
        <asp:HiddenField ID="HF_osn1" runat="server" />
        <asp:HiddenField ID="HF_osn2" runat="server" />
        <asp:HiddenField ID="HF_osn3" runat="server" />
        <asp:HiddenField ID="HF_osn4" runat="server" />
        <asp:HiddenField ID="HF_osn5" runat="server" />
        <asp:HiddenField ID="HF_osn6" runat="server" />
